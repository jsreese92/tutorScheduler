...
<head>
	...
	<script type="text/javascript" src="DBShow.js"></script>
	<meta charset="UTF-8">
	<title>Show All Tutor Preferences</title>
</head>
<body>
<button onclick='goBack()'>Back to Administrator Overview Page</button>
<br>
<button type='button' onclick='logout()'>Log Out</button>
<div align="center"><h1>Tutor Preferences</h1></div>
</body>
</html>
<?php
//Create connection
